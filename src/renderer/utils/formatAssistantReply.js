/**
 * Same logic as `src/main/aiReplyFormat.js` (CommonJS for Electron main).
 * Kept as ESM here so Vite can bundle the renderer. Keep both files in sync.
 */
...
export function formatAssistantReply(raw) {
...
export { extractAssistantPayload, stripMarkdownFence };
